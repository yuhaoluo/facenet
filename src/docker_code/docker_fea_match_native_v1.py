...
def fea_match_output(input_dic,output_url,match_res):
    #TODO 
    r = []
    try:
        for i in range(len(match_res)):
            ...
            for j in range(len(cur_res)):
                ...
                cur_similarity = cur_res[j]['similarity']
                    ...
                    for i in range(len(db_info_list)):
                        for j in range(len(face_lib_list)):
                            if db_info_list[i] ==  face_lib_list[j]['param']:
                                ...
                                #print("match res:")
                                #print(matchRes)
                                fea_match_output(taskJson_dic,output_url,matchRes)
